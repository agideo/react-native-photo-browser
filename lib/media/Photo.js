...
export default class Photo extends Component {
  ...
  static propTypes = {
    ...
    /* onZoomHorizontalOuterRangeOffset handle page change*/
    onZoomHorizontalOuterRangeOffset: PropTypes.func,
    ...
    if (this.props.zoom) {
      return (
        <ImageZoom cropWidth={zoomSize.width}
          ...
          cropWidth={zoomSize.width}
          imageWidth={sizeStyle.width}
          imageHeight={sizeStyle.height}
          horizontalOuterRangeOffset={this.props.onZoomHorizontalOuterRangeOffset}
        >
          <Image
            {...this.props}
            style={[styles.image, sizeStyle, this.props.imageStyle]}
            source={source}
